...
2. Create your own service. Use **Create Service** [API] ([./create-service](https://github.com/NornirAS/HACKATHON_2023/blob/main/HIVE_API.md#create-service)) to do so.
